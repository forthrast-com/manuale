...
- One surface throughout, #fdfcf9. A darker board behind the masthead and
  footer was tried and dropped: it read as a second colour rather than as
  depth, and it forced --muted and gold darker to clear 4.5:1 against it.
- Ink moved to #1c1a17. The old #28251f was hue 40° at 22% saturation, which is
  why the wordmark read brown rather than black. Paper moved to #fdfcf9, hue
  45° at 2%: #f8f5ed read yellow across a full office.
...
- Dark mode is a true #000000 throughout, so the OLED benefit is whole-page.
  The dark accents run 7.08:1 to 12.04:1 on black.
